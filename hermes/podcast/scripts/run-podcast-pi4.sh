...
#     $TTS_URL_FALLBACK on failure (fast failover).
#     PRIMARY = rgb 4090 GPU chatterbox (RTF ~0.15; the service is brought up
#     05:50-06:45 ET by chatterbox-on/off.timer on rgb, covering the 06:00 run).
