...
const summary=r=>({model:r.scriptModel,validated:r.authoringValidated,attempt:r.authoringAttempt,wordCount:r.wordCount,paragraphCount:r.paragraphCount,promptLeakageDetected:r.promptLeakageDetected===true,promptLeakagePhrases:r.promptLeakagePhrases||[],validationErrors:r.validationErrors||[],scriptSha256:r.script_sha256,scriptText:r.scriptText});
